...
// near-hairline 6px, then to a near-flush PANEL_TO_DOCK_GAP_PX (2px, on further real user
// feedback that 6px still read as two separate pieces) - paired with the same corner radius on
// both surfaces - so the two independently-z-indexed elements (still two elements, for the real
