...
// analysis-profile-authoring-migration-contract.test.mjs - proves migration 066's two columns
...
if (!hasDb) {
  ...
  test('migration 066 is applied: analysis_profiles has custom_method_links and custom_focuses, both JSONB defaulted', async () => {
