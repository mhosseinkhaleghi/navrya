 ...
 * @typedef {{id:string,sessionId:string,character:string,market:string,timeframe:string,date:string,movementSequence:SessionMovementPoint[],patternIds:string[],strategyIds:string[],scenarioOutcomes:{patternId:string|null,occurred:boolean}[],tradeSummary:{count:number,wins:number,losses:number,netPnl:number|null},fateSummaryText:string,createdAt:string}} SessionSignature
 * @typedef {{similarity:number,sessionId:string,character:string,market:string,timeframe:string,date:string,fateSummaryText:string,reasons:string[],signature:SessionSignature}} RankedSessionMatch
 */
