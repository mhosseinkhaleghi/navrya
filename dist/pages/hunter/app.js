...
const translations = {
  fa: {
    brandTitle: 'دفتر سناریوهای چارت', brandSub: "Hunter's Chart Journal", hunterTitle: 'شکارچی', hunterMotto: 'صبر کن، رصد کن، شکار کن.', hunterLevel: 'سطح شکارچی حرفه‌ای', hunterQuote: 'شکارچی عجله نمی‌کند؛\nاو انتظار بهترین لحظه\nرا دارد.',
    huntMarks: 'نشان شکار', scenarios: 'سناریوها', huntSetups: 'ستاپ‌های شکار', streakDays: 'روزهای توالی',
  ...
  ar: {
    brandTitle: 'دفتر سيناريوهات الرسم البياني', brandSub: "Hunter's Chart Journal", hunterTitle: 'الصيّاد', hunterMotto: 'اصبر، راقب، ثم اصطد.', hunterLevel: 'مستوى الصيّاد المحترف', hunterQuote: 'الصياد لا يستعجل؛\nإنه ينتظر أفضل لحظة\nليتحرك.',
    huntMarks: 'علامات الصيد', scenarios: 'السيناريوهات', huntSetups: 'إعدادات الصيد', streakDays: 'أيام الاستمرارية',
  ...
  en: {
    brandTitle: 'Chart Scenario Journal', brandSub: "Hunter's Chart Journal", hunterTitle: 'Hunter', hunterMotto: 'Wait. Observe. Hunt.', hunterLevel: 'Professional Hunter Level', hunterQuote: 'A hunter never rushes;\nhe waits for the right\nmoment to act.',
    huntMarks: 'Hunt marks', scenarios: 'Scenarios', huntSetups: 'Hunt setups', streakDays: 'Streak days',
  ...
  es: {
    brandTitle: 'Diario de escenarios', brandSub: "Hunter's Chart Journal", hunterTitle: 'Cazador', hunterMotto: 'Espera, observa, caza.', hunterLevel: 'Nivel de cazador profesional', hunterQuote: 'Un cazador no se apresura;\nespera el mejor\nmomento para actuar.',
    huntMarks: 'Marcas de caza', scenarios: 'Escenarios', huntSetups: 'Configuraciones', streakDays: 'Días de racha',
...
const interfaceTranslations = {
  fa: { psychology: 'روانشناسی', subscription: 'اشتراک', ai: 'هوش مصنوعی', forum: 'تالار گفتگو', chatWithAI: 'گفتگو با هوش مصنوعی', aiAssistant: 'راهنمای هوش مصنوعی', frontendOnly: 'نسخهٔ نمایشی · بدون اتصال زنده', chatWelcome: 'سلام شکارچی؛ برای تحلیل سشن بعدی آماده‌ام.', chatPlaceholder: 'پیامت را بنویس...' },
  ar: { psychology: 'علم النفس', subscription: 'الاشتراك', ai: 'الذكاء الاصطناعي', forum: 'منتدى النقاش', chatWithAI: 'تحدث مع الذكاء الاصطناعي', aiAssistant: 'مساعد الذكاء الاصطناعي', frontendOnly: 'واجهة تجريبية · دون اتصال مباشر', chatWelcome: 'مرحباً أيها الصياد؛ أنا جاهز لجلسة التحليل التالية.', chatPlaceholder: 'اكتب رسالتك...' },
  en: { psychology: 'Psychology', subscription: 'Subscription', ai: 'AI Assistant', forum: 'Community', chatWithAI: 'Chat with AI', aiAssistant: 'AI Guide', frontendOnly: 'Demo interface · no live connection', chatWelcome: 'Hello Hunter — I am ready for your next session review.', chatPlaceholder: 'Write a message...' },
  es: { psychology: 'Psicología', subscription: 'Suscripción', ai: 'Asistente IA', forum: 'Comunidad', chatWithAI: 'Hablar con IA', aiAssistant: 'Guía de IA', frontendOnly: 'Interfaz de demostración · sin conexión en vivo', chatWelcome: 'Hola, cazador. Estoy listo para revisar tu próxima sesión.', chatPlaceholder: 'Escribe un mensaje...' }
};
...
const quoteVariants = {
  fa: ['شکارچی عجله نمی‌کند؛\nاو انتظار بهترین لحظه\nرا دارد.', 'بهترین شکارها\nدر سکوت و تمرکز\nپیدا می‌شوند.', 'هر سشن، یک رد تازه\nبرای بهتر شدن\nبه جا می‌گذارد.'],
  ar: ['الصياد لا يستعجل؛\nإنه ينتظر أفضل لحظة\nليتحرك.', 'أفضل الفرص تظهر\nفي الصمت والتركيز\nلا في العجلة.', 'كل جلسة تترك\nأثراً جديداً\nعلى طريق الإتقان.'],
  en: ['A hunter never rushes;\nhe waits for the right\nmoment to act.', 'The best hunts are found\nin silence, focus,\nand patience.', 'Every session leaves\na new trail toward\nmastery.'],
  es: ['Un cazador no se apresura;\nespera el mejor\nmomento para actuar.', 'Las mejores oportunidades\nnacen del silencio,\nel enfoque y la paciencia.', 'Cada sesión deja\nun nuevo rastro hacia\nla maestría.']
};
...
function applyLanguage(language) {
  ...
  updateQuote();
  localStorage.setItem('hunter-language', language);
}
