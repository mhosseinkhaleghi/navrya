...
const translations = {
  fa: {
    brandTitle: 'دفتر سناریوهای مهندس بازار', brandSub: "Engineer's Chart Journal", hunterTitle: 'مهندس بازار', hunterSub: 'The Engineer', hunterMotto: 'تحلیل کن، ساختار بده، اجرا کن.', hunterLevel: 'سطح مهندسی حرفه‌ای', hunterQuote: 'مهندس بازار شتاب نمی‌کند؛\nساختار را می‌سنجد\nو بعد با دقت اجرا می‌کند.',
    huntMarks: 'نشان سازه', scenarios: 'سناریوها', huntSetups: 'دقت تحلیل', streakDays: 'روزهای توالی',
  ...
  ar: {
    brandTitle: 'دفتر سيناريوهات مهندس السوق', brandSub: "Engineer's Chart Journal", hunterTitle: 'مهندس السوق', hunterSub: 'The Engineer', hunterMotto: 'حلّل، نظّم، ثم نفّذ.', hunterLevel: 'مستوى المهندس المحترف', hunterQuote: 'مهندس السوق لا يتسرع؛\nيختبر البنية\nثم ينفذ بدقة.',
    huntMarks: 'شارة التصميم', scenarios: 'السيناريوهات', huntSetups: 'دقة التحليل', streakDays: 'أيام الاستمرارية',
  ...
  en: {
    brandTitle: "Engineer's Chart Journal", brandSub: "Engineer's Chart Journal", hunterTitle: 'Market Engineer', hunterSub: 'The Engineer', hunterMotto: 'Analyse. Structure. Execute.', hunterLevel: 'Professional Engineer Level', hunterQuote: 'An engineer never rushes;\nthey test the structure\nand execute with precision.',
    huntMarks: 'Design marks', scenarios: 'Scenarios', huntSetups: 'Analysis', streakDays: 'Streak days',
  ...
  es: {
    brandTitle: 'Diario del ingeniero', brandSub: "Engineer's Chart Journal", hunterTitle: 'Ingeniero de mercado', hunterSub: 'The Engineer', hunterMotto: 'Analiza. Estructura. Ejecuta.', hunterLevel: 'Nivel de ingeniero profesional', hunterQuote: 'Un ingeniero no se apresura;\nevalúa la estructura\ny ejecuta con precisión.',
    huntMarks: 'Marcas de diseño', scenarios: 'Escenarios', huntSetups: 'Análisis', streakDays: 'Días de racha',
...
const interfaceTranslations = {
  fa: { psychology: 'روانشناسی', subscription: 'اشتراک', ai: 'هوش مصنوعی', forum: 'تالار گفتگو', chatWithAI: 'گفتگو با هوش مصنوعی', aiAssistant: 'دستیار تحلیل مهندسی', frontendOnly: 'نسخهٔ نمایشی · بدون اتصال زنده', chatWelcome: 'سلام مهندس؛ برای تحلیل ساختار سشن بعدی آماده‌ام.', chatPlaceholder: 'پیامت را بنویس...' },
  ar: { psychology: 'علم النفس', subscription: 'الاشتراك', ai: 'الذكاء الاصطناعي', forum: 'منتدى النقاش', chatWithAI: 'تحدث مع الذكاء الاصطناعي', aiAssistant: 'مساعد التحليل الهندسي', frontendOnly: 'واجهة تجريبية · دون اتصال مباشر', chatWelcome: 'مرحباً أيها المهندس؛ أنا جاهز لتحليل الجلسة التالية.', chatPlaceholder: 'اكتب رسالتك...' },
  en: { psychology: 'Psychology', subscription: 'Subscription', ai: 'AI Assistant', forum: 'Community', chatWithAI: 'Chat with AI', aiAssistant: 'Engineering Analyst', frontendOnly: 'Demo interface · no live connection', chatWelcome: 'Hello Engineer — I am ready to analyse your next session structure.', chatPlaceholder: 'Write a message...' },
  es: { psychology: 'Psicología', subscription: 'Suscripción', ai: 'Asistente IA', forum: 'Comunidad', chatWithAI: 'Hablar con IA', aiAssistant: 'Analista de ingeniería', frontendOnly: 'Interfaz de demostración · sin conexión en vivo', chatWelcome: 'Hola, ingeniero. Estoy listo para analizar tu próxima sesión.', chatPlaceholder: 'Escribe un mensaje...' }
};
...
const quoteVariants = {
  fa: ['مهندس بازار شتاب نمی‌کند؛\nساختار را می‌سنجد\nو بعد با دقت اجرا می‌کند.', 'هر تصمیم خوب\nروی داده، ساختار\nو اندازه‌گیری بنا می‌شود.', 'هر سشن، نقشه‌ای تازه\nبرای ساختن نسخه‌ای\nدقیق‌تر از سیستم است.'],
  ar: ['مهندس السوق لا يتسرع؛\nيختبر البنية\nثم ينفذ بدقة.', 'كل قرار جيد\nيبنى على البيانات\nوالبنية والقياس.', 'كل جلسة تترك\nمخططاً جديداً\nلنظام أكثر دقة.'],
  en: ['An engineer never rushes;\nthey test the structure\nand execute with precision.', 'Every sound decision\nis built on data,\nstructure and measurement.', 'Every session leaves\na sharper blueprint\nfor the system.'],
  es: ['Un ingeniero no se apresura;\nevalúa la estructura\ny ejecuta con precisión.', 'Toda buena decisión\nse construye con datos,\nestructura y medición.', 'Cada sesión deja\nun plano más claro\npara el sistema.']
};
...
function applyLanguage(language) {
  ...
  updateQuote();
  localStorage.setItem('engineer-language', language);
}
...
const savedLanguage = localStorage.getItem('engineer-language') || 'fa';
...
window.TradeJournalPanelCharacter = 'engineer';
