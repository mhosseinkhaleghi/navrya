...
const GOOGLE_CLIENT_ID = '443787785968-2e2nvrnt4lsq70ob5i2pvj3ujo6uekmf.apps.googleusercontent.com';
...
const translations = {
  en: {
    ...
    hunterShort: 'Hunter', engineerShort: 'Engineer', commanderShort: 'Commander', sageShort: 'Master',
    ...
    sageName: 'The Market Master', sageRole: 'Market Master', sageRank: 'Grand Market Master · IV', sageMotto: 'The goal is not profit; it is understanding.', sageBullet1: 'Continuous deep learning', sageBullet2: 'Build patterns and laws', sageBullet3: 'Focus on the market’s essence', sageBullet4: 'Search for market wisdom',
  ...
  ar: {
    ...
    hunterShort: 'الصياد', engineerShort: 'المهندس', commanderShort: 'القائد', sageShort: 'الأستاذ',
    ...
    sageName: 'الأستاذ', sageRole: 'أستاذ السوق', sageRank: 'الأستاذ الأعظم للسوق · IV', sageMotto: 'الهدف ليس الربح بل الفهم.', sageBullet1: 'تعلم عميق مستمر', sageBullet2: 'بناء الأنماط والقوانين', sageBullet3: 'التركيز على جوهر السوق', sageBullet4: 'البحث عن حكمة السوق',
  ...
  es: {
    ...
    hunterShort: 'Cazador', engineerShort: 'Ingeniero', commanderShort: 'Comandante', sageShort: 'Maestro',
    ...
    sageName: 'El Maestro del Mercado', sageRole: 'Maestro del mercado', sageRank: 'Gran Maestro del Mercado · IV', sageMotto: 'La meta no es el beneficio; es comprender.', sageBullet1: 'Aprendizaje profundo continuo', sageBullet2: 'Crea patrones y leyes', sageBullet3: 'Enfoque en la esencia del mercado', sageBullet4: 'Busca sabiduría de mercado',
