(function () {
  ...
  registerKnowledgeDomain({
    ...
    verifiedAgainst: ['navrya-src/aiAssistantView.jsx', 'navrya-src/aiWalletUsageView.jsx', 'navrya-src/chatDockView.jsx', 'public/pages/shared/ai-settings-store.js']
  });
