(function () {
  ...
  function syncRank() {
    const ranks = {
      ...
      // Ranks 5/6 renamed off "Market Master"/"Market Sage" (2026-09-07 character rename) so
      // neither collides with the character's own new display name, "Market Master" - bumped up a
      // tier of grandeur each instead ("Senior..." then "Grand...") rather than reusing the name.
      sage:{ fa:['مرید','پژوهشگر','تحلیلگر ارشد','استاد الگوها','استاد ارشد بازار','استاد بزرگ بازار','افسانه بازار'], ar:['مريد','باحث','محلل أول','سيد الأنماط','أستاذ السوق الأول','الأستاذ الأعظم للسوق','أسطورة السوق'], en:['Disciple','Researcher','Senior Analyst','Master of Patterns','Senior Market Master','Grand Market Master','Market Legend'], es:['Discípulo','Investigador','Analista sénior','Maestro de patrones','Maestro sénior de mercado','Gran Maestro del Mercado','Leyenda del mercado'] }
    };
