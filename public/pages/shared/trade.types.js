(function () {
  ...
  window.TradeJournalTradeTypes = {
    ...
    tradeWizardPaths: ['direction','marginMode','entryPrice','stopLoss','riskPercent','riskAmount','leverage','positionSize','primaryTimeframe','chartNote','conceptTags','accountId','instrument'],
