...
/* One engine's real logo, normalised onto the ink surface. Files live under
   assets/models/{id}.png (provider-supplied, see ARCHITECTURE.md's Global AI Assistant
...
function ModelGlyph({ model, size = 18, animate = false, muted = false, style, ...rest }) {
  ...
  return (
    <img
      src={assetUrl('assets/models/' + model.id + '.png')} alt="" aria-hidden="true" draggable="false"
      style={{
