...
const copy = {
  fa: {
    ...
    switcherLabel: 'در سوییچر سریع در دسترس', hunterName: 'شکارچی', commanderName: 'فرمانده', engineerName: 'مهندس بازار', sageName: 'استاد بازار',
  ...
  ar: {
    ...
    switcherLabel: 'متاحة في المبدّل السريع', hunterName: 'الصياد', commanderName: 'القائد', engineerName: 'مهندس السوق', sageName: 'أستاذ السوق',
  ...
  en: {
    ...
    switcherLabel: 'Available in the quick switcher', hunterName: 'The Hunter', commanderName: 'The Commander', engineerName: 'Market Engineer', sageName: 'Market Master',
  ...
  es: {
    ...
    switcherLabel: 'Disponible en el selector rápido', hunterName: 'El Cazador', commanderName: 'El Comandante', engineerName: 'Ingeniero de mercado', sageName: 'Maestro del mercado',
