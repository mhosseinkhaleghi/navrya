...
- feat/gemini-voice-profiles (Codex): separate Gemini Voice profile editor, non-blocking GPT-safe refresh, and release-gate fixture/login compatibility repairs | validation: 146 focused tests passed | next: guarded dev/production promotion on request
