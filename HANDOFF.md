...
- `fix/session-auth-routing` (Codex): fixed CSRF/logout, Google chooser wait, fail-closed auth bootstrap, server-backed character/language preferences, and Gemini Voice error cleanup/end controls | validation: 125 focused tests passed | next: user browser verification
